            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div id="privacy-policy-three" class="privacy-policy">
                        <form method="post" action="{{ URL::to('admin/catering/store') }}" name="about" id="about" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3 col-md-6">
                                    <div class="form-group">
                                        <label for="item_name" class="col-form-label">Product Price</label>
                                        <input type="text" class="form-control" name="product_price" id="product-price" placeholder="Enter Product Price">
                                        @if ($errors->has('item_name'))
                                            <span class="text-danger">{{ $errors->first('item_name') }}</span>
                                        @endif
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-sm-3 col-md-4">
                                    <div class="form-group">
                                        <label for="delivery_time" class="col-form-label">Select Quantity</label>
                                        <input type="text" class="form-control" name="minimum_people" id="delivery_time" placeholder="{{ trans('messages.enter_delivery_time') }}">
                                    </div>
                                </div>
                                <div class="col-sm-3 col-md-4">
                                    <div class="form-group">
                                ...
                                <div class="col-sm-3 col-md-4">
                                    <div class="form-group">
                                        <label for="delivery_time" class="col-form-label">Preparation Time (In Minutes)</label>
                                        <input type="text" class="form-control" name="preparation_time" id="delivery_time" placeholder="20">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-2 mt-2">
                                ...
                                <div class="col-md-4" id="p_type">
                                    <h5>Product Type</h5>
                                    <label>
                                        <input type="hidden" name="item_type" value="catering">
                                        <input type="radio" name="item_type" value="catering" checked disabled>
                                        Catering
                                    </label>
                                </div>
                            </div>

                            <div class="row" id="cateringCat" style="">
                                ...
                                <h5>Add Sides</h5>
                                 ...
                                 <div class="col-sm-1">
                                        <div class="form-group">
                                            <div class="input-group">
                                                <div class="input-group-btn">
                                                    <button class="btn btn-info mt-4" type="button"  onclick="add_sides_field();"> + </button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
function remove_sides_field(rid) {
    "use strict";
   $('.removeclassIng'+rid).remove();
}
