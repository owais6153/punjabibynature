...
<div class="row page-titles mx-0">
    <div class="col p-md-0">
        ...
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addIngredients" data-whatever="@addIngredients">Add Addon Groups</button>
        <!-- Add Ingredients -->
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Add Addon Groups</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="addons_group_name" class="col-form-label">Addon Group Name</label>
                ...
                <form method="post" name="editAddongroups" class="editAddongroups" id="editAddongroups" enctype="multipart/form-data">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="get_addongroups_name" class="col-form-label">Ingredient Type</label>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive" id="table-display">
                                @include('theme.addonGroupsTable')
                    </div>
                </div>
            </div>
        </div>
...
$(document).ready(function() {
    ...
    $('#add_addon_groups').on('submit', function(event){
        ...
        $('#preloader').show();
        $.ajax({
            url:"{{ URL::to('admin/addons/groups/store') }}",
            method:"POST",
            data:form_data,
            cache: false,
            contentType: false,
    ...
    $('#editAddongroups').on('submit', function(event){
        ...
        $('#preloader').show();
        $.ajax({
            url:"{{ URL::to('admin/addons/groups/update') }}",
            method:'POST',
            data:form_data,
            cache: false,
            contentType: false,
...
function GetData(id) {
    ...
    $.ajax({
        ...
        url:"{{ URL::to('admin/addons/groups/show') }}",
        data: {
            id: id
        },
    ...
    function(isConfirm) {
        if (isConfirm) {
            $.ajax({
                ...
                url:"{{ URL::to('admin/addons/groups/delete') }}",
                data: {
                    id: id
                },
                method: 'POST',
...
function IngredientsTypeTable() {
    $('#preloader').show();
    $.ajax({
        url:"{{ URL::to('admin/addons/groups/list') }}",
        method:'get',
